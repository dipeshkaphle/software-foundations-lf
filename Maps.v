...
Proof.
  ...
  - rewrite e. rewrite eqb_refl. apply eqb_neq in H.
    rewrite H. reflexivity.
  - destruct (eqb_spec x x2).
    -- rewrite e. rewrite eqb_refl.
       apply eqb_neq in H. rewrite eqb_sym.
       rewrite H. reflexivity.
    -- apply eqb_neq in n. apply eqb_neq in n0.
       rewrite eqb_sym in n.
       rewrite eqb_sym in n0.
       rewrite n in *.
       rewrite n0 in *.
       reflexivity.
Qed.
