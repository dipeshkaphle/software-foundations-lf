...
Proof.
  ...
  - destruct c eqn:Ec.
    + simpl. reflexivity.
    +  simpl. intros h. discriminate (*This tells false=true is impossible and solves*).
  - simpl.  discriminate.
Qed.

Theorem andb_true_elim2_v2 : forall b c : bool,
  andb b c = true -> c = true.
Proof.
  intros b c.
  intros h.
...
(*      | 0, n' => ( n' + 1 ) *)
(*      | S m', 0 => ( ackerman m' 1 ) *)
(*      | S m', S n' => ackerman m' (ackerman (m' + 1) n) *)
(*   end. *)
(* FILL IN HERE
...
(** Now that we have a definition of grades and how they compare to
    one another, let us implement a late-penalty function. *)
...
Proof.
  ...
  - destruct m eqn:Em.
    ...
    + simpl. rewrite letter_comparison_Eq. reflexivity.
    + simpl. destruct l eqn:El.
      * simpl. reflexivity.
      * simpl. reflexivity.
      * simpl. reflexivity.
      * simpl. reflexivity.
      * rewrite <- lower_grade_F_Minus. rewrite <- HFMinus. simpl. reflexivity.
Qed.
...
Proof.
  intros late_days g Hld1 Hld2 HFMinus.
  rewrite apply_late_policy_unfold.
  rewrite Hld1.
  rewrite Hld2.
  reflexivity.
